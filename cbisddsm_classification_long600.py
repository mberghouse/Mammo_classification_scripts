...
for i in range(383):
    ...
    ### For whole images
      ...
      train_dataloader = DataLoader(train_dataset, batch_size=batch_size,shuffle=True, pin_memory = False,num_workers=4 )
      val_dataloader = DataLoader(val_dataset, batch_size=batch_size, shuffle = True, pin_memory = False,num_workers=4 )
    


        
      epochs = np.random.randint(18,34)
    #epochs=20
      hidden_size = 64
      dropout = np.random.uniform(0.01,0.3)   
