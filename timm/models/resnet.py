...
class BasicBlock(nn.Module):
    ...
    def __init__(
        ...
        #self.att1 = create_attn(attn_layer, first_planes)
        ...
        self.att2 = create_attn(attn_layer, outplanes)
...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        #self.att2 = create_attn(attn_layer, width)
        ...
        self.att3 = create_attn(attn_layer, outplanes)
...
@register_model
def ssl_cbam_resnet50(pretrained=False, **kwargs):
    model_args = dict(
...
@register_model
def ssl_se_resnet50(pretrained=False, **kwargs):
    model_args = dict(
        block=Bottleneck, layers=[3, 4, 6, 3], 
...
@register_model
def CBAMresnet34(pretrained=False, **kwargs):
    model_args = dict(
...
@register_model
def GEresnet34(pretrained=False, **kwargs):
    model_args = dict(
        block=BasicBlock, layers=[3, 4, 6, 3], 
        block_args=dict(attn_layer='ge'), **kwargs)
    return _create_resnet('tv_resnet34', pretrained, **model_args)
...
@register_model
def ECAresnet34(pretrained=False, **kwargs):
    model_args = dict(
        block=BasicBlock, layers=[3, 4, 6, 3], 
        block_args=dict(attn_layer='eca'), **kwargs)
    return _create_resnet('tv_resnet34', pretrained, **model_args)
...
@register_model
def CECAresnet34(pretrained=False, **kwargs):
    model_args = dict(
        block=BasicBlock, layers=[3, 4, 6, 3], 
        block_args=dict(attn_layer='ceca'), **kwargs)
    return _create_resnet('tv_resnet34', pretrained, **model_args)
...
@register_model
def halo_resnet50d(pretrained=False, **kwargs):
    model_args = dict(
        block=BasicBlock, layers=[3, 4, 6, 3],  stem_width=32, stem_type='deep', avg_down=True,
        block_args=dict(attn_layer='halo'), **kwargs)
    return _create_resnet('resnet50d', pretrained, **model_args)
    
@register_model
def split_resnet34(pretrained=False, **kwargs):
    model_args = dict(
        block=BasicBlock, layers=[3, 4, 6, 3],  
        block_args=dict(attn_layer='splat'), **kwargs)
    return _create_resnet('resnet34', pretrained, **model_args)
 
@register_model
def gather_resnet34(pretrained=False, **kwargs):
    model_args = dict(
        block=BasicBlock, layers=[3, 4, 6, 3],  
        block_args=dict(attn_layer='ge'), **kwargs)
    return _create_resnet('resnet34', pretrained, **model_args)
...
@register_model
def global_resnet34(pretrained=False, **kwargs):
    model_args = dict(
        block=BasicBlock, layers=[3, 4, 6, 3],
        block_args=dict(attn_layer='gc'), **kwargs)
    return _create_resnet('tv_resnet34', pretrained, **model_args)
...
def nonlocal_resnet50(pretrained=False, **kwargs):
    model_args = dict(
        block=Bottleneck, layers=[3, 4, 6, 3], 
        block_args=dict(attn_layer='nl'), **kwargs)
    return _create_resnet('resnet50', pretrained, **model_args)
...
@register_model
def seresnet50d(pretrained=False, **kwargs):
    model_args = dict(
        block=Bottleneck, layers=[3, 4, 6, 3],  stem_width=32, stem_type='deep', avg_down=True,
        block_args=dict(attn_layer='se'), **kwargs)
