...
for i in range(180):
   ...
   # else:
   # 	epochs=18
    epochs = np.random.randint(14,28)
    hidden_size = 64
 ...
 ###########################      
    ...
    if i<3:
        ...
        #epochs = np.random.randint(20,30)
 ...
 ###########################       
        ...
        #epochs = np.random.randint(15,22)
 ...
 ###########################       
        ...
        model_name = 'CBAMresnet50'
        #epochs = np.random.randint(19,23)
        model = timm.create_model(model_name, pretrained=True)
        lr = np.random.uniform(4e-5,8e-5)
        dataset = "300x500-v6-calc"
...
#         model.layer4[i].att2.channel.act = nn.LeakyReLU(.1)
    ...
    if i%3 == 0:
        PATH='/home/mbadhan/Desktop/mberghouse/pytorch_models/weights/5_06/'+model_name+metadata_list[0][0:3]+dataset[0:6]+'_weights'
        torch.save(model.state_dict(), PATH)
        PATH='/home/mbadhan/Desktop/mberghouse/pytorch_models/models/5_06/'+model_name+metadata_list[0][0:3]+dataset[0:6]+'_model'
