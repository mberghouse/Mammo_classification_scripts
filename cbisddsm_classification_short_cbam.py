...
def train_model(model, model_name,criterion, optimizer, scheduler, num_epochs=25):
    ...
    for epoch in range(num_epochs):
        ...
        if (tr_loss < .55)&(val_loss < .4):
            break
        elif (tr_loss<.45)&(val_loss < .5):
            break
...
for i in range(174):
   ...
   # 	epochs=18
    ...
    #epochs = np.random.randint(14,20)
    #if i<1:
 ...
 ###########################      
    ...
    if i<4:
        ...
        epochs = np.random.randint(21,23)
        model = timm.create_model(model_name, pretrained=True)
        ...
        epochs = np.random.randint(25,30)
        model = timm.create_model(model_name, pretrained=True)
        lr = np.random.uniform(3e-5,5e-5)
        dataset = "300x500-v6-mass"
        ...
        model_name = 'CBAMregnetx_064'
        model = timm.create_model(model_name, pretrained=True)
        lr = np.random.uniform(4e-5,9e-5)
        dataset = "300x500-v6-calc"
 ...
 ###########################       
        ...
        #baseline_name
        model = timm.create_model(model_name, pretrained=True)
        lr = np.random.uniform(2e-5,5e-5)
        dataset = "300x500-v6-mass"
 ...
 ###########################       
        ...
        model_name = 'GEresnet50'
        model = timm.create_model(model_name, pretrained=True)
        lr = np.random.uniform(4e-5,8e-5)
        dataset = "300x500-v6-calc"
        
    elif i<133:
        model_name = 'GEresnet34'
        model = timm.create_model(model_name, pretrained=True)
        lr = np.random.uniform(4e-5,8e-5)
        dataset = "300x500-v6-calc"
 ...
 ###########################       
        ...
        model_name = 'GEregnetx_064'
        model = timm.create_model(model_name, pretrained=True)
        lr = np.random.uniform(2e-5,5e-5)
        dataset = "300x500-v6-mass"
        
    elif i<169:
        model_name = 'GEregnetx_040'
        model = timm.create_model(model_name, pretrained=True)
        lr = np.random.uniform(2e-5,5e-5)
        dataset = "300x500-v6-mass"
        
    elif i<172:
        model_name = 'CECAregnetx_064'
        model = timm.create_model(model_name, pretrained=True)
        lr = np.random.uniform(2e-5,5e-5)
        dataset = "300x500-v6-mass"
       
    elif i<175:
        model_name = 'CECAregnetx_040'
        model = timm.create_model(model_name, pretrained=True)
        lr = np.random.uniform(2e-5,5e-5)
        dataset = "300x500-v6-mass"
...
#         model.layer4[i].att2.channel.act = nn.LeakyReLU(.1)
    ...
    if i%3 == 0:
        PATH='/home/mbadhan/Desktop/mberghouse/pytorch_models/weights/4_30_short/'+model_name+'_weights'
        torch.save(model.state_dict(), PATH)
        PATH='/home/mbadhan/Desktop/mberghouse/pytorch_models/models/4_30_short/'+model_name+'_model'
