...
from .layers import BatchNormAct2d, create_norm_act_layer, BlurPool2d, create_classifier, cbam, eca, squeeze_excite ###########
...
class DenseLayer(nn.Module):
    def __init__(
            ...
            drop_rate=0.,se_layer=squeeze_excite.SEModule,cbam_layer=cbam.CbamModule, eca_layer=eca.EcaModule,memory_efficient=False):
        ...
        if attn_layer == 'se':
            ...
            self.att = se_layer(growth_rate, rd_ratio=.125, act_layer=act_layer)
...
@register_model
def SEdensenet169(pretrained=False, **kwargs):
