...
from .layers import create_conv2d, create_classifier, get_norm_act_layer, EvoNorm2dS0, GroupNormAct, cbam, eca
...
class EfficientNet(nn.Module):
    ...
    def __init__(
            ...
            output_stride=32, pad_type='', round_chs_fn=round_channels, act_layer=None, norm_layer=None,cbam_layer=cbam.CbamModule, eca_layer=eca.EcaModule,
        ...
        builder = EfficientNetBuilder(
            ...
            act_layer=act_layer, norm_layer=norm_layer, se_layer=cbam_layer, drop_path_rate=drop_path_rate)
