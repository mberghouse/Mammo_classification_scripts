...
class SEModule(nn.Module):
    ...
    """
    def __init__(
            self, channels, rd_ratio=.125, rd_channels=None, rd_divisor=8, add_maxpool=False,
        ...
        self.act =  nn.LeakyReLU(.1,inplace=True)#create_act_layer(act_layer, inplace=True)#
