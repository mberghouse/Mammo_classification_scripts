...
from .layers import CondConv2d, get_condconv_initializer, get_act_layer, get_attn, make_divisible, cbam, eca
...
class EfficientNetBuilder:
    ...
    def __init__(self, output_stride=32, pad_type='', round_chs_fn=round_channels, se_from_exp=False,
                 act_layer=None, norm_layer=None, se_layer=None,cbam_layer=cbam.CbamModule, eca_layer=eca.EcaModule, drop_path_rate=0., feature_location=''):
        ...
        self.se_layer = get_attn(cbam_layer)
        try:
            self.se_layer(4, rd_ratio=1.0)  # test if attn layer accepts rd_ratio arg
